...
\]
which implies that we can obtain a cheap and cheerful estimate of $R_0$ by a simple linear regression. 
...
Example code for implementing SIR to model the outbreak of measles in Niamey can be found in http://kingaa.github.io/clim-dis/parest/niamey.csv. We mainly show how to use R to find the parameters in SIR model by minimizing the sum of squared errors. 
...
The R package “pomp” provides facilities for dealing with the important special case of deterministic dynamics. 
