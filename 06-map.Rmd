...
```
     ...
     (c) Put the two polygons in (a) and (b) on the same map.
     
     

2. In the following set of exercises, we will use geo-spatial data of the `state.long`. The data is readily available in the leaflet package. 
