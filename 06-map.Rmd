...
Most Shiny output widgets are incorporated into an app by including an output for the widget in the UI definition, and using a render function in the server function. For Leaflet maps, you call `leafletOutput` in the UI side, and you assign a `renderLeaflet` call to the output on the server side, and return a Leaflet map object.
